...
That architecture pattern, split the code into three modules, in order to identify quickly which roles and repsonsibilities each of these possesse. 

By identifying and categorize the codebase into different modules, troubleshooting bugs are getting easier and quicker.
