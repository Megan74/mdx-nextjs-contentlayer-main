...
Indeed, development projects are getting bigger with newer functionalities and features.  that will so more likely to face bugs and blocks along the way, as incompatibility issues for example.
