...
so the codebase remain standardized, organized, from production to its online deployment. The MVC beauty resides in its capability of changing the logic or modifiying one of these divided portions, **without** disrupting any of the rest of the project.
