    ...
    <><nav className='w-full py-4 bg-blue-800 shadow'>
          <div className='w-full container mx-auto flex flex-wrap items-center justify-between'>
              ...
              <nav>
                  ...
                  <Link href={"mailto:matandamegan@gmail.com"}><a className='hover:text-gray-200 hover:underline cursor-pointer flex gap-6  pr-8'>Projects to build? Contact me! 😀</a></Link>
              </nav>
