...
export default function Sidebar(){
    ...
    return (
        ...
        <div className="w-full bg-white shadow flex flex-col my-4 p-6">
            ...
            <Link></Link><a href="#" class="w-full bg-blue-800 text-white font-bold text-sm uppercase rounded hover:bg-blue-700 flex items-center justify-center px-2 py-3 mt-4">
                Get to know us
            </a>
        </div>
        )}