...
export default function Header() {
  ...
  return (
    ...
    <div className="flex items-center text-lg no-underline text-white pr-6">
        ...
        <a className= "social" ><ImGithub className='text-white' /></a>
        </Link>
        <Link href={'https://twitter.com/techiemeggy'}>
    <a className= "social"><ImTwitter className='text-white'/></a>
    </Link>
    <Link href={'https://www.linkedin.com/in/megan-mat/'}>
    <a className= "social"><ImLinkedin className='text-white'/></a>
    </Link>
</div>
