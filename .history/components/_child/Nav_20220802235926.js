        ...
        <><nav className="w-full py-4 border-t border-b bg-gray-100" x-data="{ open: false }">
            <div className="block sm:hidden">
                <Link><a
                    ...
                    Topics <i /> :className="open ? 'fa-chevron-down': 'fa-chevron-up'" className="fas ml-2"></i></a></Link></div><div className="open ? 'block': 'hidden'" className="w-full flex-grow sm:flex sm:items-center sm:w-auto">
