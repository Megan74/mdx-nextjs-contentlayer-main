    ...
    <><nav className='w-full py-4 bg-blue-800 shadow'>
          <div className='w-full container mx-auto flex flex-wrap items-center justify-between'>
              ...
              <div className='flex items-center text-lg no-underline text-white pr-6'>
                  ...
                  <Link href={"https://github.com/Megan74"}><a className='pl-6'><i className='fab fa-github'></i></a></Link>
                  <Link href={'https://twitter.com/techiemeggy'}><a className='pl-6'><i className='fab fa-twitter'></i></a></Link>
                  <Link href={'https://www.linkedin.com/in/megan-mat/'}><a className='pl-6'><i className='fab fa-linkedin'></i></a></Link>
