...
export default function Nav(){
    ...
    return (
        ...
        <><nav className="class=" mx-auto navbar fixed-top navbar-expand-sm py-4 border-t border-b bg-gray-100" x-data="{ open: false }">
    
                <div className="container mx-auto flex flex-col sm:flex-row items-center justify-center text-sm font-bold uppercase mt-0 px-6 py-2">
